...
var autoprefixer = _interopDefault(require('postcss-preset-env/node_modules/autoprefixer'));
var browserslist = _interopDefault(require('browserslist'));
var cssdb = _interopDefault(require('postcss-preset-env/node_modules/cssdb'));
var postcss$1 = _interopDefault(require('postcss-preset-env/node_modules/postcss'));
var postcssAttributeCaseInsensitive = _interopDefault(require('postcss-preset-env/node_modules/postcss-attribute-case-insensitive'));
var postcssBlankPseudo = _interopDefault(require('css-blank-pseudo/postcss'));
var postcssColorFunctionalNotation = _interopDefault(require('postcss-preset-env/node_modules/postcss-color-functional-notation'));
var postcssColorGray = _interopDefault(require('postcss-preset-env/node_modules/postcss-color-gray'));
var postcssColorHexAlpha = _interopDefault(require('postcss-preset-env/node_modules/postcss-color-hex-alpha'));
var postcssColorModFunction = _interopDefault(require('postcss-preset-env/node_modules/postcss-color-mod-function'));
var postcssColorRebeccapurple = _interopDefault(require('postcss-color-rebeccapurple'));
var postcssCustomMedia = _interopDefault(require('postcss-preset-env/node_modules/postcss-custom-media'));
var postcssCustomProperties = _interopDefault(require('postcss-preset-env/node_modules/postcss-custom-properties'));
var postcssCustomSelectors = _interopDefault(require('postcss-preset-env/node_modules/postcss-custom-selectors'));
var postcssDirPseudoClass = _interopDefault(require('postcss-preset-env/node_modules/postcss-dir-pseudo-class'));
var postcssDoublePositionGradients = _interopDefault(require('postcss-preset-env/node_modules/postcss-double-position-gradients'));
var postcssEnvFunction = _interopDefault(require('postcss-preset-env/node_modules/postcss-env-function'));
var postcssFocusVisible = _interopDefault(require('postcss-preset-env/node_modules/postcss-focus-visible'));
var postcssFocusWithin = _interopDefault(require('postcss-preset-env/node_modules/postcss-focus-within'));
var postcssFontVariant = _interopDefault(require('postcss-font-variant'));
var postcssGapProperties = _interopDefault(require('postcss-preset-env/node_modules/postcss-gap-properties'));
var postcssHasPseudo = _interopDefault(require('css-has-pseudo/postcss'));
var postcssImageSetPolyfill = _interopDefault(require('postcss-preset-env/node_modules/postcss-image-set-function'));
var postcssInitial = _interopDefault(require('postcss-initial'));
var postcssLabFunction = _interopDefault(require('postcss-preset-env/node_modules/postcss-lab-function'));
var postcssLogical = _interopDefault(require('postcss-preset-env/node_modules/postcss-logical'));
var postcssMediaMinmax = _interopDefault(require('postcss-media-minmax'));
var postcssNesting = _interopDefault(require('postcss-preset-env/node_modules/postcss-nesting'));
var postcssOverflowShorthand = _interopDefault(require('postcss-preset-env/node_modules/postcss-overflow-shorthand'));
var postcssPageBreak = _interopDefault(require('postcss-page-break'));
var postcssPlace = _interopDefault(require('postcss-preset-env/node_modules/postcss-place'));
var postcssPrefersColorScheme = _interopDefault(require('css-prefers-color-scheme/postcss'));
var postcssPseudoClassAnyLink = _interopDefault(require('postcss-preset-env/node_modules/postcss-pseudo-class-any-link'));
var postcssReplaceOverflowWrap = _interopDefault(require('postcss-replace-overflow-wrap'));
var postcssSelectorMatches = _interopDefault(require('postcss-preset-env/node_modules/postcss-selector-matches'));
var postcssSelectorNot = _interopDefault(require('postcss-preset-env/node_modules/postcss-selector-not'));
var caniuse = require('postcss-preset-env/node_modules/caniuse-lite');
